                ...
                <div class="panel-body">
                    ...
                    <form action="<?php echo base_url('admin/update-admin');?>" method="post">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" name="nama" placeholder="Masukan Nama Admin" value="<?php echo $data_admin['nama_admin'];?>" required="required">
                        </div>
                        <div style="clear:both;"></div>

                        <div class="form-group col-md-6">
                            <label>Username Admin</label>
                            <input type="text" class="form-control" value="<?php echo $data_admin['username_admin'];?>" readonly="readonly" onKeyPress="return goodchars(event, 'abcdefghijklmnopqrstuvwxyz_ABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890',this)" name="username" placeholder="Masukan Username Pengguna" required="required">
                        </div>
                        <div style="clear:both;"></div>
